        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <div class="form-group">
                    ...
                    <input type="email" class="form-control-plaintext" readonly id="email" value="{{@Data:email}}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control-plaintext" readonly id="sdt" value="0{{@Data:phone}}">
                </div>
